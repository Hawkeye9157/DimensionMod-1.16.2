...
public class k.mod.vinespirit<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition R_Arm = partdefinition.addOrReplaceChild("R_Arm", CubeListBuilder.create().texOffs(22, 31).addBox(-1.0F, -5.0F, -3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		PartDefinition R_Leg = partdefinition.addOrReplaceChild("R_Leg", CubeListBuilder.create().texOffs(26, 11).addBox(-1.0F, -2.0F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
